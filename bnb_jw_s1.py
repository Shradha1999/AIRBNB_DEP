...
Original file is located at
    https://colab.research.google.com/drive/1gjmL-dux8b4QS-Y5FeJdPDm0kcm1QXNv
"""
...
st.subheader('''TRAVEL DESTINATION PREDICTION USING AIRBNNB
(DEPLOYMENT USING STREAMLIT BY SHRADHANJALI PRADHAN)''')
st.write('''
